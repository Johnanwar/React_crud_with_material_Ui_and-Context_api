...
function CarLicence({match}) {
 ...
 function handleSubmit(e) {
        ...
        console.log(DocImage);
          ...
          .then(res => {
            handlehistory( action.ADD , 'تحميل صورة الرقم القومي     ' ,  "  تحميل صورة الرقم القومي         ")
            history.push(`/Passport/${match.params.id}/${match.params.type}`)
            notify()
          })
